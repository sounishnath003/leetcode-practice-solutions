<h2><a href="https://leetcode.com/problems/minimum-initial-energy-to-finish-tasks">Minimum Initial Energy to Finish Tasks</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given an array <code>tasks</code> where <code>tasks[i] = [actual<sub>i</sub>, minimum<sub>i</sub>]</code>:</p>
